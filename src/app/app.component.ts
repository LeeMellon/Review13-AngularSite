...
export class AppComponent {
  ...
  // }
  //
  // editClickedArticle(clickedArticle){
  //   this.selectedEditArticle = clickedArticle;
  // }
  //
  // finishEdit(){
  //   this.selectedEditArticle = null;
  // }
